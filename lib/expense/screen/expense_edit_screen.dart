...
class ExpenseEditScreen extends StatelessWidget {
  ...
  ExpenseEditScreen(this.expense);
  ...
  void onUpdate(TextEditingController amountController, TextEditingController descController, TextEditingController noteController) async{
